...
class ShapeResultTests(unittest.TestCase):
    ...
    def _found_result(self) -> SearchResult:
        return SearchResult(
            po_number="651842",
            outcome="found",
            vendor_name="Sai Computer Care - HO",
    ...
    def test_it_role_never_sees_document_number_transaction_date_or_description(self):
        ...
        self.assertNotIn("transaction_description", shaped)
        ...
        self.assertEqual(shaped["vendor_name"], "Sai Computer Care - HO")

    def test_it_role_sees_only_the_vendor_for_a_non_found_outcome(self):
        result = SearchResult(po_number="648811", outcome="payment_in_process", vendor_name="Some Vendor", document_number="20270001347")
        shaped = _shape_result(result, role="it")
        self.assertEqual(shaped, {"po_number": "648811", "outcome": "payment_in_process", "vendor_name": "Some Vendor"})
