...
CREATE TABLE IF NOT EXISTS `background_jobs` (
  ...
  `client_tab_id` VARCHAR(64) NULL,
  `client_heartbeat_at` DATETIME NULL,
  `cancel_on_disconnect` BOOLEAN NOT NULL DEFAULT FALSE,
  ...
  KEY `ix_background_jobs_client_tab_id` (`client_tab_id`),
  KEY `ix_background_jobs_client_heartbeat_at` (`client_heartbeat_at`),
